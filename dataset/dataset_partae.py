...
class PartAEDataset(Dataset):
    ...
    def load_part_data_info(self, phase):
        ...
        with open(f'{self.data_root}/easyscene_info.json', 'r') as fp:
    ...
    def __getitem__(self, index):
        ...
        n_parts, parts_voxel, data_points, data_values, data_category = load_from_hdf5_by_part(shape_path, part_idx, self.resolution)
        ...
        #batch_affine = torch.tensor(data_affines, dtype=torch.float32)
